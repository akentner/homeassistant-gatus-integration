...
- [x] **Phase 4: Distribution** - HACS-ready hacs.json and validated manifest.json (completed 2026-05-31)
...
- [x] 01-01-PLAN.md — Scaffold: constants, manifest, hacs.json, dev toolchain

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 01-02-PLAN.md — Coordinator: GatusEndpoint + GatusDataUpdateCoordinator (TDD)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-03-PLAN.md — Lifecycle: async_setup_entry / async_unload_entry + full suite verification
...
- [x] 03-02-PLAN.md — binary_sensor.py + sensor.py (all 4 entity types + stale cleanup)
...
- [x] 04-01-PLAN.md — README.md + brand/icon.png (HACS information + brands checks)
- [x] 04-02-PLAN.md — GitHub Actions validate.yml + manifest/hacs field verification
...
| 4. Distribution | 2/2 | Complete | 2026-05-31 |
